...
App::~App()
{
    ...
    pEvtMgr->VRemoveListener( m_fromLuaTestEvtDelegate,
...
bool App::Init()
{
    ...
    REGISTER_SCRIPT_EVENT( EvtDataScriptEventToLua,
                           EvtDataScriptEventToLua::sk_EventType );
    REGISTER_SCRIPT_EVENT( EvtDataScriptEventFromLua,
                           EvtDataScriptEventFromLua::sk_EventType );
    ...
    IEventManager* pEvtMgr = IEventManager::GetInstance();
    assert( pEvtMgr );
    pEvtMgr->VAddListener( m_fromLuaTestEvtDelegate,
                           EvtDataScriptEventFromLua::sk_EventType );
