...
bool LuaStateManager::VInit()
{
    ...
    m_pLuaState->GetGlobals().RegisterDirect( "ExecuteFile", (*this),
                                              &LuaStateManager::VExecuteFile );
    m_pLuaState->GetGlobals().RegisterDirect( "ExecuteString", (*this),
...
LuaPlus::LuaObject
LuaStateManager::CreatePath( const char* pathString,
...
void
LuaStateManager::ConvertVec3ToTable( const Vec3& vec,
...
void LuaStateManager::ConvertTableToVec3( const LuaPlus::LuaObject& luaTable,
                                          Vec3& outVec3 ) const
{
