...
set LIBS=glew32.lib opengl32.lib SDL2.lib SDL2main.lib SDL2_mixer.lib zlibd.lib assimp-vc142-mtd.lib Bullet3Collision_Debug.lib Bullet3Dynamics_Debug.lib
::set CFLAGS=/EHsc /O2 /std:c++11
set CFLAGS=/EHsc /O2 /DEBUG /Zi
